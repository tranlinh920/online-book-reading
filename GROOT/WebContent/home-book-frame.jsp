...
<body>
	...
	<%
		...
		if (session.getAttribute("BookList") != null)
			lob = (ArrayList<Book>) session.getAttribute("BookList");
	%>
	...
	<div class="row" style="margin-top: 20px;">
		...
		<%
			if (request.getAttribute("BookList") != null ||session.getAttribute("BookList") != null) {
				for (Book b : lob) {
		%>
		<!--sach 1-->
		<div class="col-4 book-frame">
			...
			<div class="book-overlay">
				...
				<form
					...
					method="post">
					<a><button name="laterWatchingBtn" type="submit" id="watchBtn"
							class="btn btn-primary" style="width: 100%">Xem sau</button></a>
				</form>
			</div>
